async function init() {
    if (window.ethereum == null) {
        ...
        contract = new ethers.Contract("0xf52e496d2b8787d6643D80c0e03a8a09A940842e", abi, provider);
        ...
        network = await provider.getNetwork();
        contract = new ethers.Contract("0xf52e496d2b8787d6643D80c0e03a8a09A940842e", abi, signer);
        console.log("selected provider: ", provider);
        console.log("network:", network);
